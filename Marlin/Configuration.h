...
#define STRING_SPLASH_LINE2 "comp:"__TIME__ __DATE__ // will be shown during bootup in line 2
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,1600,400}  // default steps per unit for Ultimaker
