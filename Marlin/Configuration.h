...
#ifndef MOTHERBOARD
  #define MOTHERBOARD 80 // Changed BOARD_ULTIMAKER to 80 or BOARD_RUMBA in Marlin v1.0.2. (name BOARD_RUMBA is defined in boards.h)
#endif
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define AUTO_BED_LEVELING_GRID
    ...
    #define FRONT_PROBE_BED_POSITION 60 //30
...
#define HOMING_FEEDRATE {50*60, 60*60, 4*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {100.5,100.5,800,833}  // default steps per unit for Ultimaker
